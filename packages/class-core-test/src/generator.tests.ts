...
import { directSpecializationsPerClassifier } from "@lionweb/class-core-generator/dist/helpers/index.js"
...
describe(`class-core generator`, () => {
    ...
    it(`concept extends from Node or from nothing => class extends from NodeBase`, () => {
        ...
        const languageFile = languageFileFor(factory.language, lionWebVersion, { verbose: false, genericImportLocation: "@lionweb/class-core" }, directSpecializationsPerClassifier([factory.language]))
