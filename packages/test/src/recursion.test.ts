...
describe("Unit test for directlyContaineds function", () => {
    it('should return entities for Lnaguage objects', () => {
        ...
        // console.log("🚀 ~ file: recursion.test.ts:40 ~ it ~ result:", result)
    ...
    it('should return an empty array for non-matching M3Concepts', () => {
        ...
        // console.log("🚀 ~ file: recursion.test.ts:73 ~ it ~ result:", result)
