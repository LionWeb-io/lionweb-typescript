...
export const defineDeltas = () => {
    ...
    defineDelta(
        ...
        [
            ...
            // FIXME  just the node's ID and classifier should be transmitted
        ]
    )
    ...
    defineDelta(
        ...
        [
            node("node"),
            // TODO  express meta-pointers for classifiers, instead of features
        ]
    )
