...
export const tsTypeForFeatureKind = (kind: FeatureKinds) => {
    switch (kind) {
        case FeatureKinds.property: return "Property"
        case FeatureKinds.containment: return "Containment"
        case FeatureKinds.reference: return "Reference"
    }
}
