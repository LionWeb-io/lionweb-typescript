...
import { languagePath } from "./paths.js"


/*
 * artifacts/chunks/languages/csharp/shapes_2023_1.json is a copy of this file:
 *
 *  https://github.com/LionWeb-io/lionweb-csharp/blob/main/test/LionWeb.Core.Test/Languages/defChunks/shapes_2023_1.json
 *
 * This script is run as follows:
 *
 *  $ npm run build && node dist/csharp-shapes-language.js
 *
...
const shapesJson = readFileAsJson(languagePath("csharp/shapes_2023_1.json")) as LionWebJsonChunk
...
writeJsonAsFile(languagePath("csharp/shapes_2023_1-fixed.json"), serializeLanguages(shapesLanguage))
writeFileSync(languagePath("csharp/shapes_2023_1.txt"), languageAsText(shapesLanguage))
generateLanguage(shapesLanguage, "../deltas-websocket/src/gen", { header: defaultTrumpfOriginatingApache2_0LicensedHeader })
